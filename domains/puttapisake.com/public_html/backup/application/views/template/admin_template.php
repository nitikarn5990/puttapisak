                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-wrench"></i> จัดการสินค้า <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="<?php echo base_url()?>index.php/admin/product_type">จัดการประเภทสินค้า</a>
                                    </li>
                                    <li><a href="<?php echo base_url()?>index.php/admin/product_group">จัดการกลุ่มสินค้า</a>
                                    </li>
                                    <li><a href="<?php echo base_url()?>index.php/admin/product">จัดการรายการสินค้า</a>
                                    </li>
                                    <li><a href="index3.html">จัดการค่าขนส่ง</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-wrench"></i> จัดการการสั่งทำ <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="index.html">จัดการการสั่งทำพระพุทธชินราช</a>
                                    </li>
                                    <li><a href="index2.html">จัดการการสั่งทำพระประธาน</a>
                                    </li>
                                    <li><a href="index3.html">จัดการการสั่งทำพระพุทธรูป</a>
                                    </li>
                                    <li><a href="index3.html">จัดการการสั่งทำรูปเหมือน/รูปจำลอง</a>
                                    </li>
                                    <li><a href="index3.html">จัดการการสั่งทำองค์เทพ</a>
                                    </li>
                                    <li><a href="index3.html">จัดการการสั่งทำประติมากรรม</a>
                                    </li>
                                    <li><a href="index3.html">จัดการการสั่งทำพระเครื่อง/เหรียญคณาจารย์</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-wrench"></i> จัดการหน่วยวัด <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">

                                </ul>
                            </li>
                            <li><a><i class="fa fa-wrench"></i> จัดการรายงาน <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    <li><a href="index.html">จัดการรายงานสั่งซื้อสินค้า</a>
                                    </li>
                                    <li><a href="index2.html">จัดการรายงานสั่งทำสินค้า</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
