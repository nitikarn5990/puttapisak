<script>
    ...
    $(document).ready(function () {
        var oTable = $('#product_group').dataTable({
            "oLanguage": {
...
<div class="x_content">
    ...
    <div id="example_wrapper" class="dataTables_wrapper" role="grid">
        ...
        <table id="product_group" class="table table-striped responsive-utilities jambo_table dataTable" aria-describedby="example_info">
            <thead>
            <tr class="headings" role="row">
                ...
                <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="50" style="width: 102px;"><center>กลุ่มสินค้า</center></th>
                <th class="no-link last sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 239px;"><center>สถาณะกลุ่มสินค้า</center></th>
                <th class="no-link last sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 239px;"><center>แก้ไขกลุ่มสินค้า</center></th>
                <th class="no-link last sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 239px;"><center>ลบกลุ่มสินค้า</center></th>
            </tr>
            </thead>
