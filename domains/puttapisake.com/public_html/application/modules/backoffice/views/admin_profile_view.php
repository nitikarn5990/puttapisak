                    ...
                    <?php foreach($data_admin as $admin) {
                        ...
                        <div class="col-xs-10 col-sm-10">
                            <div class="form-group required">
                                ...
                                <input required="required" type="text" class="form-control" id="adimn_Name"
                                       name="admin_Name" value="<?= $admin['admin_Name'] ?>">
                            </div>
                            <div class="form-group required">
                                <label for="InputLastname"> นามสกุล </label>
                                <input required="required" type="text" class="form-control" id="adimn_Lastname"
                                       name="admin_Lastname"
                    ...
                    <form method="post" id="" action="/" enctype="multipart/form-data">
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div class="form-group required">
                                ...
                                <label for="InputName"><strong> พิศาล </strong></label>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group required">
                            ...
                            <div class="form-group required">
                                ...
                                <label for="InputLastname"><strong> แก้วลี </strong></label>
                            </div>
                        </div>
                    </form>
                    <div class="col-lg-12">
